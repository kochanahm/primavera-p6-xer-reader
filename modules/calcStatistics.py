...
isTaskExist = False
isTaskPredExist = False
isCalendarExist = False
isTaskRsrcExist = False
isSchedOptionsExist = False
isProjectExist = False

def checkTableExist():
    global isTaskExist
    global isTaskPredExist
    global isCalendarExist
    global isTaskRsrcExist
...
def find_proj_start_date():
    if isTaskExist:
        ...
        if df_micro1.empty:
            prj_start_date_str = "2100-01-01 00:00"
            prj_start_date_obj1 = datetime.datetime.strptime(prj_start_date_str, '%Y-%m-%d %H:%M')
        else:
        ...
        if df_micro2.empty:
            prj_start_date_str = "1900-01-01 00:00"
            prj_start_date_obj2 = datetime.datetime.strptime(prj_start_date_str, '%Y-%m-%d %H:%M')
        else:
        ...
        prj_start_date_str = "1900-01-01 00:00"
        prj_start_date_obj = datetime.datetime.strptime(prj_start_date_str, '%Y-%m-%d %H:%M')
...
def find_proj_end_date():
    if isTaskExist:
        ...
        if df_micro3.empty:
            prj_end_date_str = "1900-01-01 00:00"
            prj_end_date_obj1 = datetime.datetime.strptime(prj_end_date_str, '%Y-%m-%d %H:%M')
        else:
        ...
        if df_micro4.empty:
            prj_end_date_str = "1900-01-01 00:00"
            prj_end_date_obj2 = datetime.datetime.strptime(prj_end_date_str, '%Y-%m-%d %H:%M')
        else:
        ...
        prj_end_date_str = "1900-01-01 00:00"
        prj_end_date_obj = datetime.datetime.strptime(prj_end_date_str, '%Y-%m-%d %H:%M')
...
def create_task_status_table():
    if isTaskExist:
        ...
        cnt_completed_tasks = 0
        cnt_inprogress_tasks = 0
        cnt_notstarted_tasks = 0
...
def create_task_type_table():
    if isTaskExist:
        ...
        cnt_task_dependent = 0
        cnt_wbs_summary = 0
        cnt_loe = 0
        cnt_start_milestone = 0
        cnt_finish_milestone = 0
        cnt_resource_dependent = 0
...
def create_float_table():
    if isTaskExist:
        ...
        cnt_no_float = 0
        cnt_negative_float = 0
        cnt_critical_float = 0
        cnt_0_44_float = 0
        cnt_greater44_float = 0
        cnt_min_sml30 = 0
        cnt_min_20_30 = 0
        cnt_min_10_20 = 0
        cnt_min_5_10 = 0
